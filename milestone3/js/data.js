...
//FUNZIONE CHE SI ATTIVA AL CAMBIAMENTO DEL SELECT

function val() {
    sceltaSelect = document.getElementById("select_id").value;

    document.getElementById('container-box').innerHTML = '';

    // alert(sceltaSelect);

     if(sceltaSelect==='4') sceltaColore(blueIcon);
     if(sceltaSelect==='3') sceltaColore(greenIcon);
     if(sceltaSelect==='2') sceltaColore(orangeIcon);
     if(sceltaSelect==='1') sceltaColore(icons);
}


//FUNZIONE PER GENERARE LE ICONE IN BASE ALLA SCELTA DEL COLORE
